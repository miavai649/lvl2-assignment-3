...
export const initializePayment = async (payload: TransactionData) => {
  try {
    const response = await axios.post(config.payment_url!, {
      ...
      success_url: `https://lvl-2-assignment-3-nine.vercel.app/api/payment/confirmation?status=success`,
      fail_url: `https://lvl-2-assignment-3-nine.vercel.app/api/payment/confirmation?status=failed`,
